...
void __fastcall TForm2::ImageNassauCliffMouseMove(TObject *Sender, TShiftState Shift,
          int X, int Y)
{
	int DX = X - NaCfDiaXOrigin;
	int DY = Y - NaCfDiaYOrigin;

	sCol->Text = (DX-DX%HtWd)/HtWd;
	sRow->Text = (DY-DY%HtWd)/HtWd;
}
//---------------------------------------------------------------------------

void __fastcall TForm2::ImageLathamKrulishMouseMove(TObject *Sender, TShiftState Shift,
          int X, int Y)
{
	int DX = X - LaKrDiaXOrigin;
	int DY = Y - LaKrDiaYOrigin;
...
void __fastcall TForm2::ImageHydeYardPortMouseMove(TObject *Sender, TShiftState Shift,
          int X, int Y)
{
	int DX = X - HyYdPtDiaXOrigin;
	int DY = Y - HyYdPtDiaYOrigin;
